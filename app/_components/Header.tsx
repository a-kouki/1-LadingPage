    ...
    <div className=" bg-bg-primary flex justify-center pt-0 sm:pt-5 pb-10 px-2 md:px-pxGloabl">
        <div className="relative max-w-widthGlobal w-full h-100 ">
            ...
            <div className="flex gap-x-3 sm:gap-x-10 items-center pt-8 text-[15px]">
                ...
                target="_blank"
                className="font-bold border border-secondary text-secondary px-7 py-1 rounded-4xl hover:cursor-pointer hover:text-white hover:border-white hover:bg-primary">
