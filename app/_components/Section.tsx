...
import { OtherProducts } from "./Other_Products";
    ...
    return(
        ...
        <div className="text-[13px] md:text-[19px]  grid grid-cols-1 md:grid-cols-3 gap-x-10 px-2 md:px-pxGloabl max-w-widthGlobal font-abeezee items-center">
            <div className="flex  flex-col items-start sm:items-center">
                <p className="text-primary text-2xl sm:text-3xl font-bebas">Vendedor de Veículos</p>
        ...
        <div className="flex justify-center pt-20 bg-bg-primary text-black">
